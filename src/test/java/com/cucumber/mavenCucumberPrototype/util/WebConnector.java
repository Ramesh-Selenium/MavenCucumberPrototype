package com.cucumber.mavenCucumberPrototype.util;
	...
	private WebConnector(){
		...
		if(OR==null){
			try{
				// initialize OR
				OR = new Properties();
				FileInputStream fs  = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\java\\com\\cucumber\\mavenCucumberPrototype\\config\\OR.properties");
				OR.load(fs);
				
				// initialize CONFIG to corresponding env
				CONFIG= new Properties();
				fs  = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\java\\com\\cucumber\\mavenCucumberPrototype\\config\\"+OR.getProperty("testEnv")+"_config.properties");
				CONFIG.load(fs);
